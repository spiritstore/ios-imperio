...
struct ContentView: View {
    ...
    private enum GameMode: String, CaseIterable {
        ...
        var patchPrefix: String { self == .normal ? "ImperioStore" : "OGIOS" }
    ...
    private var developerCredits: some View {
        VStack(spacing: 10) {
            Text("Desenvolvido por Imperio Store")
        ...
        NavigationStack {
            Form {
                Section {
                    ...
                    Text("Digite a senha uma vez para desbloquear este pacote Imperio Store neste dispositivo.")
                }
            }
