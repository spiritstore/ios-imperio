...
func log(_ msg: String) { AppLog.shared.append("[Imperio Store] \(msg)") }
...
enum AppUpdateChecker {
    ...
    static let apiURL = URL(string: "https://api.github.com/repos/YangJiiii/ImperioStore/releases/latest")!
    static let fallbackURL = URL(string: "https://github.com/YangJiiii/ImperioStore/releases/latest")!
    ...
    static func check() async -> Offer? {
        ...
        request.setValue("ImperioStore", forHTTPHeaderField: "User-Agent")
