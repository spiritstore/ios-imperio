# Create clean Imperio Store project from nullhex
# 1. Copy project_updated to project_imperio
# 2. Revert branding (Imperio Store + blue theme)
# 3. Push to spiritstore/ios-imperio

$projDir = "C:\Users\jhz\Desktop\azzzzzzzzzzzzzzzz\project_imperio"
$srcDir = "C:\Users\jhz\Desktop\azzzzzzzzzzzzzzzz\project_updated"

# Copy all files
Copy-Item -Path "$srcDir\*" -Destination $projDir -Recurse -Force
Write-Host "Copied project files"
...
$replacements = @{
    ...
    "ImperioStore-ESign-Ready-IPA" = "ImperioStore-ESign-Ready-IPA"
    "FDEcfOiXxAsC57nQzVW4210gKmGoNBjh" = "IMPERIO_ADMIN_2024"
    "k8xP2mN7qR4tW9vL1sA3bC5dE0fG6hJ" = "IMPERIO_ADMIN_2024"
}
...
# Initialize fresh git and push
Set-Location $projDir
Remove-Item .git -Recurse -Force -ErrorAction SilentlyContinue
git init
git remote add origin "https://github.com/spiritstore/ios-imperio.git"
git add -A
git commit -m "Imperio Store - blue theme, original branding"
git branch -M main
git push -u origin main

Write-Host "Done! Pushed to https://github.com/spiritstore/ios-imperio"
