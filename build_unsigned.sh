...
ARCHIVE="$BUILD_DIR/ImperioStore.xcarchive"
IPA="$BUILD_DIR/ImperioStore.ipa"
...
/usr/libexec/PlistBuddy -c "Set :CFBundleDisplayName Imperio Store" "$APP/Info.plist" || true
/usr/libexec/PlistBuddy -c "Set :CFBundleName Imperio Store" "$APP/Info.plist" || true
